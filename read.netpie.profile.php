        ...
        for ($i = 0; $i < 7; $i++)
        {
    		...
    		if ($set_weekday == "") {
    			...
    			if ($Enable == "true") {
    				...
    				echo $cron_weekday . "/home/pi/thingscontrol/bin/thingson " . $GLOBALS["OnTimer"] . " >> /var/log/thingson.log 2>&1\n";
    				$time1 = $cron_weekday . "/home/pi/thingscontrol/bin/thingson " . $GLOBALS["OnTimer"] . " >> /var/log/thingson.log 2>&1\n";
    			...
    			if ($Enable2 == "true") {
    				...
    				echo $cron_weekday . "/home/pi/thingscontrol/bin/thingson " . $GLOBALS["OnTimer"] . " >> /var/log/thingson.log 2>&1\n";
    				$time2 = $cron_weekday . "/home/pi/thingscontrol/bin/thingson " . $GLOBALS["OnTimer"] . " >> /var/log/thingson.log 2>&1\n";
    			...
    			if ($Enable3 == "true") {
    				...
    				echo $cron_weekday . "/home/pi/thingscontrol/bin/thingson " . $GLOBALS["OnTimer"] . " >> /var/log/thingson.log 2>&1\n";
    				$time3 = $cron_weekday . "/home/pi/thingscontrol/bin/thingson " . $GLOBALS["OnTimer"] . " >> /var/log/thingson.log 2>&1\n";
